        ...
        <Stack vertical>
          <Stack.Item>
            ...
            >
              ...
              {selectedCount > 0 && (
                <NoticeBox mt={1} info>
                  Боевые пакеты больше не используют длинный кулдаун сектора.
                  После завершения сектора действует только короткий антиспам в
                  несколько секунд, а основной лимит задают общие заряды пакета.
                </NoticeBox>
              )}
