...
/datum/world_edit_building_archetype/hydroponics/build_definition()
	...
	add_zone("work_counter", "Work counter", "service", 3, TRUE, TRUE, FALSE, list("work_counter", "service_strip", "wall_anchor"), FALSE)
	add_zone("seed_storage", "Seed storage", "storage", 3, TRUE, TRUE, FALSE, list("seed_storage", "service_strip", "wall_anchor"), FALSE, "nook")
	...
	add_cluster("grow_bed_rows", "major", "run", "table", "table", list("grow_rows", "grow_strip"), 5, 7, FALSE, 0, 100)
	add_cluster("service_counter", "major", "run", "table", "table", list("work_counter", "service_strip", "wall_anchor"), 2, 3, TRUE, 0, 95)
	add_cluster("seed_cabinets", "major", "run", "cabinet", "cabinet", list("seed_storage", "service_strip", "wall_anchor"), 2, 3, TRUE, 0, 90)
	...
	object_budgets = list("table" = 10, "chair" = 2, "cabinet" = 4, "rack" = 2, "crate" = 3)
	category_minimums = list("table" = 5, "cabinet" = 2)
...
/datum/world_edit_building_archetype/kitchen/build_definition()
	...
	add_zone("serving_edge", "Serving edge", "choke", 3, TRUE, TRUE, FALSE, list("serving_edge", "counter_front", "barrier_line"), FALSE)
	add_zone("prep_core", "Prep core", "hub", 7, TRUE, TRUE, FALSE, list("prep_core", "work_cluster", "focus_center"), TRUE)
	add_zone("cooking_line", "Cooking line", "service", 4, TRUE, TRUE, FALSE, list("cooking_line", "service_strip", "wall_anchor"), FALSE)
	add_zone("cold_storage", "Cold storage", "storage", 3, TRUE, TRUE, FALSE, list("cold_storage", "service_strip", "wall_anchor"), FALSE, "nook")
	...
	add_cluster("serving_counter", "major", "counter_line", "table", "table", list("serving_edge", "counter_front"), 3, 4, FALSE, 0, 100)
	add_cluster("prep_tables", "major", "table_cluster", "table", "table", list("prep_core", "work_cluster", "focus_center"), 1, 2, FALSE, 1, 95)
	add_cluster("cooking_run", "major", "run", "table", "table", list("cooking_line", "service_strip", "wall_anchor"), 3, 4, TRUE, 0, 90)
	add_cluster("cold_storage_wall", "major", "run", "cabinet", "cabinet", list("cold_storage", "service_strip", "wall_anchor"), 2, 3, TRUE, 0, 85)
	...
	object_budgets = list("table" = 9, "chair" = 8, "cabinet" = 4, "rack" = 2, "crate" = 2)
	category_minimums = list("table" = 5, "cabinet" = 2)
...
/datum/world_edit_building_archetype/dormitory/build_definition()
	...
	add_zone("sleep_bay", "Sleep bay", "private", 10, TRUE, TRUE, TRUE, list("sleep_bay", "privacy_zone", "wall_anchor"), FALSE)
	...
	add_cluster("bed_wall_runs", "major", "run", "bed", "bed", list("sleep_bay", "privacy_zone", "wall_anchor"), 4, 6, TRUE, 0, 100)
	add_cluster("locker_wall", "major", "run", "cabinet", "cabinet", list("locker_strip", "service_strip", "wall_anchor"), 3, 4, TRUE, 0, 95)
	add_cluster("ready_table", "secondary", "table_cluster", "table", "table", list("ready_area", "social_focus"), 1, 1, FALSE, 2, 60, FALSE)
...
/datum/world_edit_building_archetype/office/build_definition()
	...
	add_zone("filing_wall", "Filing wall", "storage", 3, TRUE, TRUE, FALSE, list("filing_wall", "service_strip", "wall_anchor"), FALSE)
	add_zone("private_nook", "Private nook", "private", 2, FALSE, TRUE, TRUE, list("private_nook", "privacy_zone", "wall_anchor"), FALSE, "nook")
	add_region("entry_front", "entry_buffer", 0, 18, -35, 35, 100)
	...
	add_cluster("primary_desk", "major", "table_cluster", "table", "table", list("desk_core", "work_cluster", "focus_center"), 1, 1, FALSE, 1, 100)
	add_cluster("filing_cabinets", "major", "run", "cabinet", "cabinet", list("filing_wall", "service_strip", "wall_anchor"), 2, 3, TRUE, 0, 90)
	...
	add_cluster("side_storage", "detail", "wall_object", "rack", "rack", list("private_nook", "filing_wall", "wall_anchor"), 1, 1, TRUE, 0, 35, FALSE)
	object_budgets = list("table" = 2, "chair" = 5, "cabinet" = 4, "rack" = 2, "console" = 1)
...
/datum/world_edit_building_archetype/security/build_definition()
	...
	add_zone("desk_line", "Desk line", "choke", 3, TRUE, TRUE, FALSE, list("desk_line", "counter_front", "barrier_line"), FALSE)
	add_zone("secure_work", "Secure work", "secure", 5, TRUE, TRUE, FALSE, list("secure_work", "counter_back", "work_cluster"), FALSE)
	...
	add_zone("holding_nook", "Holding nook", "private", 2, FALSE, TRUE, TRUE, list("holding_nook", "privacy_zone", "wall_anchor"), FALSE, "nook")
	...
	add_cluster("security_counter", "major", "counter_line", "table", "table", list("desk_line", "counter_front"), 3, 4, FALSE, 0, 100)
	add_cluster("security_console", "major", "wall_object", "console", "console", list("secure_work", "counter_back", "wall_anchor"), 1, 1, TRUE, 0, 95)
	add_cluster("locker_run", "major", "run", "cabinet", "cabinet", list("locker_storage", "service_strip", "wall_anchor"), 2, 3, TRUE, 0, 90)
	...
	add_cluster("holding_bed", "detail", "wall_object", "bed", "bed", list("holding_nook", "privacy_zone", "wall_anchor"), 1, 1, TRUE, 0, 35, FALSE)
	add_cluster("barrier_line", "detail", "run", "barrier", "barrier", list("public_lobby", "barrier_line"), 2, 3, FALSE, 0, 35, FALSE)
	object_budgets = list("table" = 4, "chair" = 3, "cabinet" = 4, "rack" = 2, "console" = 1, "barrier" = 3, "bed" = 1)
...
/datum/world_edit_building_archetype/chapel/build_definition()
	...
	add_cluster("altar_focus", "major", "table_cluster", "table", "table", list("sanctum", "focus_center", "semantic_hub"), 1, 1, FALSE, 0, 100)
	add_cluster("seating_left_rows", "major", "run", "chair", "chair", list("seating_rows", "social_focus"), 3, 4, FALSE, 0, 90)
	add_cluster("seating_right_rows", "major", "run", "chair", "chair", list("seating_rows", "social_focus"), 3, 4, FALSE, 0, 85)
...
/datum/world_edit_building_archetype/ritual_chamber/build_definition()
	...
	add_cluster("ritual_centerpiece", "major", "object", "table", "table", list("ritual_focus", "focus_center", "semantic_hub"), 1, 1, FALSE, 0, 100)
	add_cluster("axis_barriers", "major", "run", "barrier", "barrier", list("ritual_axis", "barrier_line"), 3, 4, FALSE, 0, 95)
	add_cluster("reliquary_wall", "major", "run", "cabinet", "cabinet", list("reliquary", "service_strip", "wall_anchor"), 2, 2, TRUE, 0, 90)
...
/datum/world_edit_building_archetype/compound_colony/build_definition()
	...
	add_zone("clinic_nook", "Clinic nook", "service", 3, FALSE, TRUE, TRUE, list("clinic_nook", "work_cluster", "wall_anchor"), FALSE, "nook")
	add_zone("command_nook", "Command nook", "nested", 1, FALSE, TRUE, TRUE, list("command_nook", "privacy_zone", "work_cluster"), FALSE)
	add_region("entry_front", "entry_buffer", 0, 16, -35, 35, 100)
	...
	add_cluster("central_table", "major", "table_cluster", "table", "table", list("central_court", "social_focus", "focus_center"), 1, 1, FALSE, 3, 100)
	add_cluster("living_beds", "major", "run", "bed", "bed", list("living_wing", "privacy_zone", "wall_anchor"), 2, 3, TRUE, 0, 95)
	add_cluster("workbench_run", "major", "run", "table", "table", list("work_bay", "service_strip", "wall_anchor"), 2, 3, TRUE, 0, 90)
	add_cluster("storage_racks", "major", "run", "rack", "rack", list("storage_service", "service_strip", "wall_anchor"), 2, 3, TRUE, 0, 85)
	...
	add_cluster("clinic_bed", "secondary", "wall_object", "medical_bed", "medical_bed", list("clinic_nook", "work_cluster", "wall_anchor"), 1, 1, TRUE, 0, 55, FALSE)
	add_cluster("command_console", "secondary", "wall_object", "console", "console", list("command_nook", "central_court", "wall_anchor"), 1, 1, TRUE, 0, 50, FALSE)
	add_cluster("supply_crates", "detail", "staging_group", "crate", "crate", list("storage_service", "work_bay"), 1, 2, FALSE, 0, 40, FALSE)
	object_budgets = list("bed" = 4, "table" = 5, "chair" = 5, "cabinet" = 4, "rack" = 4, "crate" = 3, "console" = 1, "medical_bed" = 1)
