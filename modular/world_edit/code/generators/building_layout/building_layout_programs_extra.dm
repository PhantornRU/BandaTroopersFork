...
/datum/world_edit_building_archetype/office/build_definition()
	...
	add_zone("private_nook", "Private nook", "private", 2, FALSE, TRUE, TRUE, list("private_nook", "privacy_zone", "wall_anchor"), FALSE, "room")
	add_region("entry_front", "entry_buffer", 0, 18, -35, 35, 100)
...
/datum/world_edit_building_archetype/security/build_definition()
	...
	add_zone("holding_nook", "Holding nook", "private", 2, TRUE, TRUE, TRUE, list("holding_nook", "privacy_zone", "wall_anchor"), FALSE, "room")
	...
	add_signature_cluster("holding_bed", "major", "wall_object", "bed", "bed", list("holding_nook", "privacy_zone", "bed_wall"), 1, 1, TRUE, 0, 75, "holding_cell", 15)
