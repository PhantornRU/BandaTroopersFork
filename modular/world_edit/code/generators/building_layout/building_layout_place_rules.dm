...
/datum/world_edit_generator/building_layout/proc/get_building_place_rule_catalog()
	...
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("cabinet", "cabinet", 1, 0, TRUE, WORLD_EDIT_BUILDING_DIRMODE_FRONT_FACE, default_forbidden_anchors, 10))
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("bed", "bed", 1, 0, TRUE, WORLD_EDIT_BUILDING_DIRMODE_FRONT_FACE, default_forbidden_anchors, 15))
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("rack", "rack", 1, 0, TRUE, WORLD_EDIT_BUILDING_DIRMODE_FRONT_FACE, default_forbidden_anchors, 10))
	...
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("console", "console", 1, 1, TRUE, WORLD_EDIT_BUILDING_DIRMODE_FRONT_FACE, default_forbidden_anchors, 15))
	...
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("medical_bed", "medical_bed", 1, 0, FALSE, WORLD_EDIT_BUILDING_DIRMODE_FRONT_FACE, default_forbidden_anchors, 15))
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("medical_storage", "medical_storage", 1, 0, TRUE, WORLD_EDIT_BUILDING_DIRMODE_ATTACHED_WALL, default_forbidden_anchors, 10))
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("hydro_tray", "hydro_tray", 1, 0, FALSE, WORLD_EDIT_BUILDING_DIRMODE_FRONT_FACE, default_forbidden_anchors, 25))
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("fridge", "cold_storage", 1, 0, TRUE, WORLD_EDIT_BUILDING_DIRMODE_FRONT_FACE, default_forbidden_anchors, 10))
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("filing", "cabinet", 1, 0, TRUE, WORLD_EDIT_BUILDING_DIRMODE_FRONT_FACE, default_forbidden_anchors, 10))
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("wall_monitor", "console", 1, 0, TRUE, WORLD_EDIT_BUILDING_DIRMODE_ATTACHED_WALL, default_forbidden_anchors, 10))
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("security_console", "console", 1, 1, TRUE, WORLD_EDIT_BUILDING_DIRMODE_FRONT_FACE, default_forbidden_anchors, 20))
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("sleeper", "medical_bed", 1, 0, FALSE, WORLD_EDIT_BUILDING_DIRMODE_FRONT_FACE, default_forbidden_anchors, 25))
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("medical_scanner", "medical_bed", 1, 0, FALSE, WORLD_EDIT_BUILDING_DIRMODE_FRONT_FACE, default_forbidden_anchors, 20))
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("microwave", "kitchen_machine", 1, 0, TRUE, WORLD_EDIT_BUILDING_DIRMODE_FRONT_FACE, default_forbidden_anchors, 15))
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("processor", "kitchen_machine", 1, 0, TRUE, WORLD_EDIT_BUILDING_DIRMODE_FRONT_FACE, default_forbidden_anchors, 15))
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("processor", "work_machine", 1, 0, TRUE, WORLD_EDIT_BUILDING_DIRMODE_FRONT_FACE, default_forbidden_anchors, 20))
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("sink", "kitchen_machine", 1, 0, TRUE, WORLD_EDIT_BUILDING_DIRMODE_FRONT_FACE, default_forbidden_anchors, 10))
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("water_tank", "water_or_chem", 1, 0, TRUE, WORLD_EDIT_BUILDING_DIRMODE_FRONT_FACE, default_forbidden_anchors, 10))
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("seed_storage", "seed_storage", 1, 0, TRUE, WORLD_EDIT_BUILDING_DIRMODE_FRONT_FACE, default_forbidden_anchors, 10))
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("security_camera", "security_camera", 1, 0, TRUE, WORLD_EDIT_BUILDING_DIRMODE_ATTACHED_WALL, default_forbidden_anchors, 15))
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("brig_cell", "security_machine", 1, 0, TRUE, WORLD_EDIT_BUILDING_DIRMODE_FRONT_FACE, default_forbidden_anchors, 10))
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("weapon_rack", "weapon_rack", 1, 0, TRUE, WORLD_EDIT_BUILDING_DIRMODE_FRONT_FACE, default_forbidden_anchors, 10))
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("engineering_machine", "engineering_machine", 1, 0, TRUE, WORLD_EDIT_BUILDING_DIRMODE_FRONT_FACE, default_forbidden_anchors, 25))
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("power_console", "console", 1, 1, TRUE, WORLD_EDIT_BUILDING_DIRMODE_FRONT_FACE, default_forbidden_anchors, 20))
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("lab_machine", "lab_machine", 1, 0, TRUE, WORLD_EDIT_BUILDING_DIRMODE_FRONT_FACE, default_forbidden_anchors, 20))
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("sample_storage", "sample_storage", 1, 0, TRUE, WORLD_EDIT_BUILDING_DIRMODE_FRONT_FACE, default_forbidden_anchors, 12))
	...
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("apc", "apc", 1, 0, TRUE, WORLD_EDIT_BUILDING_DIRMODE_ATTACHED_WALL, default_forbidden_anchors, 45))
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("air_alarm", "air_alarm", 1, 0, TRUE, WORLD_EDIT_BUILDING_DIRMODE_ATTACHED_WALL, default_forbidden_anchors, 45))
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("fire_alarm", "fire_alarm", 1, 0, TRUE, WORLD_EDIT_BUILDING_DIRMODE_ATTACHED_WALL, default_forbidden_anchors, 35))
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("light_switch", "light_switch", 1, 0, TRUE, WORLD_EDIT_BUILDING_DIRMODE_ATTACHED_WALL, default_forbidden_anchors, 30))
	return place_rule_catalog
