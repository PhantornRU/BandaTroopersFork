...
/datum/world_edit_generator/building_layout/proc/get_building_place_rule_catalog()
	...
	add_building_place_rule(place_rule_catalog, new /datum/world_edit_building_place_rule("console", "console", 1, 0, TRUE, WORLD_EDIT_BUILDING_DIRMODE_FRONT_FACE, default_forbidden_anchors, 15))
