...
/datum/world_edit_generator/outpost_radius
	...
	var/static/list/outpost_legacy_family_to_defense_profile = list(
		"metal_perimeter" = "lane_fort",
		"wired_metal_perimeter" = "lane_fort",
		"plasteel_bastion" = "anti_vehicle_stop",
		"plasteel_wired_bastion" = "anti_vehicle_stop",
		"sandbag_redoubt" = "fallback_redoubt",
		"wooden_screen" = "outrider_camp",
		"mixed_standard" = "lane_fort",
		"mixed_siege" = "anti_vehicle_stop",
		"expedition_light" = "outrider_camp",
		"assault_screen" = "outrider_camp",
		"choke_wall" = "pocket_defense",
		"killbox_wired" = "anti_vehicle_stop",
		"bastion_heavy" = "anti_vehicle_stop",
		"mixed_siege_plus" = "crossfire_hub",
		"sandbag_nest" = "fallback_redoubt",
		"wooden_emergency" = "outrider_camp",
		"fallback_redoubt" = "fallback_redoubt",
		"lane_fort" = "lane_fort",
		"pocket_defense" = "pocket_defense",
		"crossfire_hub" = "crossfire_hub",
		"anti_vehicle_stop" = "anti_vehicle_stop",
		"outrider_camp" = "outrider_camp",
		"forward_medical_cover" = "forward_medical_cover",
	)
