...
/datum/world_edit_generator/outpost_radius
	...
	var/static/list/outpost_defense_profiles = list(
		...
		"lane_fort" = list(
			"label" = "Линейный форт",
			"description" = "Фронтальные sentry-точки, проволока у входов и мины на подступах.",
			"defense_rules" = list(
				list(
					"kind" = "sentry",
					"group" = "guard_slots",
		...
		"crossfire_hub" = list(
			...
			"description" = "Глубокие sentry-углы с башней поддержки и минами на подступах.",
			"defense_rules" = list(
				list(
					"kind" = "sentry",
					"group" = "corner_slots",
		...
		"anti_vehicle_stop" = list(
			...
			"description" = "Тяжелые DMR-точки, усиленный фронт и мины на подходе.",
			"defense_rules" = list(
				list(
					"kind" = "sentry",
					"group" = "guard_slots",
		...
		"forward_medical_cover" = list(
			...
			"description" = "Минимум оружия, понятная mark-точка и безопасные подходы.",
			"defense_rules" = list(
				list(
					"kind" = "sentry",
					"group" = "rear_slots",
