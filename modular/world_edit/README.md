...
- `code/generators/world_edit_generator_*.dm`: реализации генераторов.
...
- `docs/generator_catalog_seed.md`: каталог генераторов v1.3.
- `docs/generators/*.md`: паспорта ready-генераторов.
