...
- `code/generators/world_edit_generator_*.dm`: runtime-реализации ready surface и исторические deprecated legacy-compatible ветки на диске.
...
- `docs/generators/*.md`: исторические паспорта deprecated генераторов.
