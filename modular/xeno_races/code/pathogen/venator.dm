...
/mob/living/carbon/xenomorph/venator
	...
	icon_xeno = 'modular/xeno_races/icons/mob/pathogen/venator.dmi'
	icon_xenonid = 'modular/xeno_races/icons/mob/pathogen/venator.dmi'
	//need_weeds = FALSE

	weed_food_icon = 'modular/xeno_races/icons/mob/xenos/weeds_48x48.dmi'
	mycelium_food_icon = 'modular/xeno_races/icons/mob/pathogen/pathogen_weeds_48x48.dmi'
