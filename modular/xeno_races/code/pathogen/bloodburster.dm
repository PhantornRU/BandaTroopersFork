...
/mob/living/carbon/xenomorph/bloodburster
	...
	icon_xeno = 'modular/xeno_races/icons/mob/pathogen/bloodburster.dmi'
	icon_xenonid = 'modular/xeno_races/icons/mob/pathogen/bloodburster.dmi'
	need_weeds = FALSE

	weed_food_icon = 'modular/xeno_races/icons/mob/xenos/weeds_64x64.dmi'
	mycelium_food_icon = 'modular/xeno_races/icons/mob/pathogen/pathogen_weeds_64x64.dmi'
