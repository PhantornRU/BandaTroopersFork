/obj/item/clothing/suit/marine/unsc
	...
	desc = "Штатная броня корпуса морской пехоты UNSC. Комплект M52B поступил на вооружение к 2531 году для войны людей с Ковенантом и обеспечивал лучшую защиту от плазменного оружия по сравнению со старыми моделями."
