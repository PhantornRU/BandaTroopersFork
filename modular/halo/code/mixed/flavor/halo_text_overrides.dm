...
/obj/structure/machinery/newscaster
	desc = "Общественная доска объявлений и рекламная уродина."
...
/obj/item/reagent_container/food/drinks/cans/pepsi
	name = "Pepsi"
	desc = "Красный, белый и синий. Эту газировку всё ещё разливают в США и на ряде колоний."

/obj/item/reagent_container/food/condiment/hotsauce/sriracha
	name = "бутылка соуса срирача"
	desc = "Срирача родом из Таиланда и давно стала устойчивой классикой. Во вкусе здесь чили и чеснок, а за ними идут уксусная кислинка и лёгкая сладость."
...
/obj/item/reagent_container/food/snacks/sosjerky
	...
	desc = "Солёная, сухая и мясистая вяленая говядина. Писать домой о таком вряд ли станешь."

/obj/item/reagent_container/food/snacks/no_raisin
	name = "изюм"
	desc = "Сушёный виноград. Сладкий и чуть-чуть влажный."

/obj/item/reagent_container/food/snacks/chips
	name = "картофельные чипсы"
	desc = "Тонко нарезанный жареный картофель с солью. Классика."

/obj/item/reagent_container/food/snacks/wy_chips/pepper
	name = "картофельные чипсы с чёрным перцем"
	desc = "Помимо соли и хруста в них неожиданно много аромата и лёгкой остроты."

/obj/item/reagent_container/food/snacks/kepler_crisps
	name = "картофельные криспы"
	desc = "Хрустящие. Технически полезнее для сердца, чем обычные чипсы."

/obj/item/reagent_container/food/snacks/kepler_crisps/flamehot
	name = "острые картофельные криспы"
	desc = "Хрустящие и острые. Настоящая эпоха чудес. Вот бы ещё придумали приправу, которая не остаётся на пальцах."
...
/obj/item/reagent_container/food/snacks/microwavable/packaged_burrito
	name = "буррито для микроволновки"
	desc = "Буррито в упаковке для разогрева. На дешёвой бумажной оболочке красуется мультяшный маскот."
	warm_desc = "Разогретый буррито в упаковке. Чуть размокший, но вполне рабочий."

/obj/item/reagent_container/food/snacks/microwavable/packaged_burger
	name = "чизбургер для микроволновки"
	desc = "Булка, грустный ломтик сыра и тонкая котлета. Зато стабильно."
	warm_desc = "Разогретый чизбургер. Влажноват, возможно даже слишком, но всё ещё сытный и вкусный."

/obj/item/reagent_container/food/snacks/microwavable/packaged_hdogs
	name = "хот-дог с булкой для микроволновки"
	desc = "Булка, сосиска и пластиковая обёртка. Инструкция велит греть три минуты, но опыт подсказывает, что лучше две или меньше."
	warm_desc = "Разогретый хот-дог. Оболочка слегка лопнула, булка суховата, но есть всё ещё приятно."
...
/obj/item/trash/chips
	name = "пустой пакет из-под чипсов"
	desc = "Пустой и жирный пластиковый пакет с фольгированной подкладкой."
...
/obj/item/trash/kepler
	name = "пустая туба из-под картофельных криспов"
	desc = "Пустая картонная туба. Теперь годится разве что для поделок. Или повторного использования."

/obj/item/trash/kepler/flamehot
	name = "пустая туба из-под острых картофельных криспов"
	desc = "Пустая картонная туба. Перед повторным использованием лучше промыть, если не хотите острый сюрприз."

/obj/item/trash/buritto
	name = "обёртка от буррито для микроволновки"
	desc = "Пластиково-бумажная упаковка в следах чего-то неопознаваемого. Раньше в ней лежал буррито."
...
/obj/item/trash/hotdog
	name = "обёртка от хот-дога для микроволновки"
	desc = "Маслянистая пластиковая упаковка, в которой когда-то лежал хот-дог."
