...
/obj/item/reagent_container/hypospray/autoinjector/primeable/burnguard
	...
	chemname = "burnguard"
	desc = "Эффективный и простой в применении порошок для экстренной помощи при ожогах. Раньше встречался лишь в узких промышленных сферах, где персонал работал с экстремальным жаром или опасной химией, а теперь адаптирован для UNSC как сравнительно надёжное средство первой помощи при плазменных ожогах."
