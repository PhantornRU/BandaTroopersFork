...
/obj/item/attachable/scope/variable_zoom/oracle
	...
	desc = "Одна из самых распространённых снайперских оптических систем UNSC. Позволяет переключаться между разными режимами увеличения. Некоторые версии даже оснащены приборами ночного видения."
	icon = 'icons/halo/obj/items/weapons/guns_by_faction/unsc/unsc_attachments.dmi'
...
/obj/item/attachable/scope/variable_zoom/m6d
	...
	desc = "Умный прицел, предназначенный для установки на магнум M6D. Версия Model II заметно точнее и позволяет переключаться между двухкратным и четырёхкратным увеличением. Связывается с оптикой UNSC и выводит в HUD прицельную марку и счётчик боезапаса."
	slot = "rail"
...
/obj/item/attachable/scope/mini/smartscope/m6g
	...
	desc = "Умный прицел для магнума M6G, обеспечивающий расширенные режимы увеличения и связь с оптикой UNSC для вывода в HUD прицельной марки и счётчика боезапаса."
...
/obj/item/attachable/scope/mini/smartscope/m6c
	...
	desc = "Умный прицел для магнума M6C, обеспечивающий расширенные режимы увеличения и связь с оптикой UNSC для вывода в HUD прицельной марки и счётчика боезапаса."
	icon_state = "m6c_smartscope_obj"
