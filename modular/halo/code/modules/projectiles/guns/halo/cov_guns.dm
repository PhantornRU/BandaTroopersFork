/obj/item/weapon/gun/energy/plasma
	...
	// Sounds
	var/overheat_sound = 'modular/halo/sound/weapons/halo/plasma_overheat.ogg'
	var/manual_vent_sound = 'modular/halo/sound/weapons/halo/plasma_overheat.ogg'
...
/obj/item/weapon/gun/energy/plasma/plasma_pistol/unique_action(mob/living/carbon/human/user)
	...
	if(overcharged)
		...
		overcharged = TRUE
		toggle_overcharge_overlay()
		playsound(src, 'modular/halo/sound/weapons/halo/plasma_pistol_overcharge/overcharge.ogg', vary = TRUE)
		COOLDOWN_START(src, overcharge_cooldown, 1.5 SECONDS)
...
/obj/item/weapon/gun/energy/plasma/plasma_rifle
	...
	fire_sound = 'modular/halo/sound/weapons/halo/gun_plasmarifle_1.ogg'
...
/obj/item/weapon/gun/smg/covenant_needler
	...
	reload_sound = 'modular/halo/sound/weapons/halo/gun_needler_reload.ogg'
	cocked_sound = 'modular/halo/sound/weapons/halo/gun_needler_cocked.ogg'
	unload_sound = 'modular/halo/sound/weapons/halo/gun_needler_reload.ogg'
	flags_gun_features = GUN_CAN_POINTBLANK
	muzzleflash_icon = 'modular/halo/icons/halo/obj/items/weapons/halo_projectiles.dmi'
...
/obj/item/weapon/gun/rifle/covenant_carbine
	...
	reload_sound = 'modular/halo/sound/weapons/halo/gun_carbine_reload.ogg'
	cocked_sound = 'modular/halo/sound/weapons/halo/gun_carbine_cocked.ogg'
	unload_sound = 'modular/halo/sound/weapons/halo/gun_carbine_unload.ogg'
	empty_sound = 'modular/halo/sound/weapons/halo/gun_carbine_dryfire.ogg'
