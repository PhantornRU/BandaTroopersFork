...
/obj/item/weapon/covenant/energy_sword
	...
	hitsound = "swing_hit"
	var/on_sound = 'modular/halo/sound/weapons/halo/energy_sword/energy_sword_on.ogg'
	var/off_sound = 'modular/halo/sound/weapons/halo/energy_sword/energy_sword_off.ogg'
	var/break_sound = 'modular/halo/sound/weapons/halo/energy_sword/energy_sword_disabled.ogg'
	// light stuff
	light_color = "#7b92df"
	light_power = 0.3
	light_range = 4
