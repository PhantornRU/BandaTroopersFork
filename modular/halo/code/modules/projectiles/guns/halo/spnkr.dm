...
/obj/item/weapon/gun/halo_launcher/spnkr
	...
	reload_sound = 'modular/halo/sound/weapons/halo/gun_spnkr_reload.ogg'
	unload_sound = 'modular/halo/sound/weapons/halo/gun_spnkr_unload.ogg'
	item_icons = list(
		...
		if(!hit_type)
			...
			if(hit_type == "damage")
				...
				if(current_mob.client)
					playsound_client(current_mob.client, 'modular/halo/sound/weapons/halo/spnkr_locking/spnkr_aa_damage.ogg', src, 25)
			if(hit_type == "crash")
				...
				if(current_mob.client)
					playsound_client(current_mob.client, 'modular/halo/sound/weapons/halo/spnkr_locking/spnkr_aa_crash.ogg', src, 25)
			if(hit_type == "miss")
				to_chat(current_mob, SPAN_HIGHDANGER("You see the [missile_name] miss its target!"))
