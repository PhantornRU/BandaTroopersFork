/datum/equipment_preset/covenant/ruuhtian
	...
	languages = list(LANGUAGE_SANGHEILI, LANGUAGE_UNGGOY, LANGUAGE_RUUHTIAN)
...
/datum/equipment_preset/covenant/ruuhtian/load_race(mob/living/carbon/human/new_human, client/mob_client)
	...
	apply_ruuhtian_identity(new_human)

/datum/equipment_preset/covenant/ruuhtian/load_name(mob/living/carbon/human/new_human, randomise, client/mob_client)
	apply_ruuhtian_identity(new_human)

/datum/equipment_preset/covenant/ruuhtian/load_preset(mob/living/carbon/human/new_human, randomise = FALSE, count_participant = FALSE, client/mob_client, show_job_gear = TRUE, late_join)
	. = ..()
	if(new_human)
		new_human.halo_apply_species_tts_seed()

/datum/equipment_preset/covenant/ruuhtian/load_gear(mob/living/carbon/human/new_human)
	add_jackal_basics(new_human)
	add_jackal_minor(new_human)
	add_plasma_pistol_package(new_human)

/datum/equipment_preset/covenant/ruuhtian/proc/apply_ruuhtian_identity(mob/living/carbon/human/new_human)
...
/datum/equipment_preset/proc/add_needler_package(mob/living/carbon/human/new_human, count = 5)
...
/datum/equipment_preset/proc/add_cov_carbine_package(mob/living/carbon/human/new_human, count = 5)
...
/datum/equipment_preset/proc/add_jackal_ultra(mob/living/carbon/human/new_human)
	...
	new_human.equip_to_slot_or_del(new /obj/item/weapon/shield/riot/covenant(new_human), WEAR_L_STORE)
	var/pick_hat = pick_weight(list(/obj/item/clothing/head/helmet/marine/ruuhtian = 20, /obj/item/clothing/head/helmet/marine/ruuhtian/better = 80))
	new_human.equip_to_slot_or_del(new pick_hat(new_human), WEAR_HEAD)
