...
/datum/modpack/cyrillic_fixes/proc/update_cyrillic_radio()
	GLOB.department_radio_keys |= list(
		...
		":с" = SQUAD_MARINE_3, 				".с" = SQUAD_MARINE_3, 				"#с" = RADIO_CHANNEL_CIA,			"№с" = RADIO_CHANNEL_CIA,
		":в" = SQUAD_MARINE_4, 				".в" = SQUAD_MARINE_4, 				"#в" = RADIO_CHANNEL_MERC,			"№в" = RADIO_CHANNEL_MERC,
		...
		":й" = RADIO_CHANNEL_ROYAL_MARINE, 	".й" = RADIO_CHANNEL_ROYAL_MARINE, 	"#й" = RADIO_CHANNEL_ROYAL_MARINE,	"№й" = RADIO_CHANNEL_ROYAL_MARINE,
		"#д" = RADIO_CHANNEL_PROVOST, 											"№д" = RADIO_CHANNEL_PROVOST,
		"#к" = RADIO_CHANNEL_YAUTJA, 											"№к" = RADIO_CHANNEL_YAUTJA,
		":ы" = RADIO_CHANNEL_US_ARMY, 		".ы" = RADIO_CHANNEL_US_ARMY, 		"#ы" = RADIO_CHANNEL_US_ARMY,		"№ы" = RADIO_CHANNEL_US_ARMY,
		":ч" = RADIO_CHANNEL_USASF, 		".ч" = RADIO_CHANNEL_USASF, 		"#ч" = RADIO_CHANNEL_USASF,			"№ч" = RADIO_CHANNEL_USASF,
