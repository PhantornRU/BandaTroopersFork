...
| #1255 | UPP camouflage armor/clothes | **PORTED** | `code/modules/clothing/head/helmet.dm`, `code/modules/clothing/suits/marine_armor/ert.dm`, `code/modules/clothing/under/marine_uniform.dm`, `code/modules/clothing/under/ties.dm` | `NO_SNOW_TYPE`/`NO_NAME_OVERRIDE` flags for UPP/CANC clothing; DMI sprites (TM ONLY) |
