...
/datum/skills/military/survivor/forecon_radio
	name = "Reconnaissance Radio Telephone Operator"
	skills = list(
		SKILL_ENGINEER = SKILL_ENGINEER_DEFAULT,
		SKILL_CONSTRUCTION = SKILL_CONSTRUCTION_DEFAULT,
		SKILL_MELEE_WEAPONS = SKILL_MELEE_TRAINED,
...
/datum/skills/military/survivor/forecon_corpsman
	name = "Reconnaissance Corpsman"
	skills = list(
		SKILL_ENGINEER = SKILL_ENGINEER_DEFAULT,
		SKILL_CONSTRUCTION = SKILL_CONSTRUCTION_DEFAULT,
		SKILL_MELEE_WEAPONS = SKILL_MELEE_TRAINED,
...
/datum/skills/military/survivor/forecon_sharpshooter	//Covers marksman & the sniper-team duo
	name = "Reconnaissance Sharpshooter"
	skills = list(
		SKILL_ENGINEER = SKILL_ENGINEER_DEFAULT,
		SKILL_CONSTRUCTION = SKILL_CONSTRUCTION_DEFAULT,
		SKILL_MELEE_WEAPONS = SKILL_MELEE_TRAINED,
