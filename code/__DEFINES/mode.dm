...
GLOBAL_LIST_INIT(ROLES_MARINES, GLOB.ROLES_USCM_MARINES + JOB_HALO_MARINES_LIST) // SS220 EDIT: append HALO marine roles through the shared early-include contract
GLOBAL_LIST_INIT(ROLES_SQUAD_ALL, list(SQUAD_MARINE_1, SQUAD_MARINE_2, SQUAD_MARINE_3, SQUAD_MARINE_4, SQUAD_MARINE_5, SQUAD_MARINE_CRYO, SQUAD_MARINE_INTEL, SQUAD_UPP, SQUAD_LRRP, SQUAD_PMCPLT, SQUAD_PMCPLT_SMALL, SQUAD_RMC, SQUAD_ODST)) // SS220 EDIT: add HALO ODST squad through the shared early-include contract
