...
GLOBAL_LIST_INIT(ROLES_USCM_MARINES, list(JOB_SQUAD_LEADER, JOB_SQUAD_TEAM_LEADER, JOB_SQUAD_SPECIALIST, JOB_SQUAD_SMARTGUN, JOB_SQUAD_MEDIC, JOB_SQUAD_ENGI, JOB_SQUAD_MARINE, JOB_SQUAD_RTO))
GLOBAL_LIST_INIT(ROLES_UNSC_MARINES, list(JOB_SQUAD_LEADER_UNSC, JOB_SQUAD_TEAM_LEADER_UNSC, JOB_SQUAD_SPECIALIST_UNSC, JOB_SQUAD_MEDIC_UNSC, JOB_SQUAD_MARINE_UNSC, JOB_SQUAD_RTO_UNSC))
...
GLOBAL_LIST_INIT(ROLES_MARINES, GLOB.ROLES_USCM_MARINES + GLOB.ROLES_UNSC_MARINES + GLOB.ROLES_ODST)
GLOBAL_LIST_INIT(ROLES_SQUAD_ALL, list(SQUAD_MARINE_1, SQUAD_MARINE_2, SQUAD_MARINE_3, SQUAD_MARINE_4, SQUAD_MARINE_5, SQUAD_MARINE_CRYO, SQUAD_MARINE_INTEL, SQUAD_UPP, SQUAD_LRRP, SQUAD_PMCPLT, SQUAD_PMCPLT_SMALL, SQUAD_RMC, SQUAD_ODST)) // SS220 EDIT: add HALO ODST squad
...
GLOBAL_LIST_INIT(ROLES_USCM, ROLES_CIC + GLOB.ROLES_POLICE + GLOB.ROLES_AUXIL_SUPPORT + GLOB.ROLES_MISC + GLOB.ROLES_ENGINEERING + GLOB.ROLES_REQUISITION + GLOB.ROLES_MEDICAL + GLOB.ROLES_USCM_MARINES - ROLES_WO)
...
GLOBAL_LIST_INIT(ROLES_HALO_MARINES, GLOB.ROLES_UNSC_MARINES + GLOB.ROLES_ODST)
GLOBAL_LIST_INIT(ROLES_AI_HALO_UNSC, list(JOB_SO, JOB_SQUAD_LEADER_UNSC, JOB_SQUAD_TEAM_LEADER_UNSC, JOB_SQUAD_RTO_UNSC, JOB_SQUAD_MEDIC_UNSC, JOB_SQUAD_SPECIALIST_UNSC, JOB_SQUAD_MARINE_UNSC))
GLOBAL_LIST_INIT(ROLES_AI_HALO_ODST, list(JOB_SO, JOB_SQUAD_LEADER_ODST, JOB_SQUAD_TEAM_LEADER_ODST, JOB_SQUAD_RTO_ODST, JOB_SQUAD_MEDIC_ODST, JOB_SQUAD_SPECIALIST_ODST, JOB_SQUAD_MARINE_ODST))
GLOBAL_LIST_INIT(ROLES_DISTRESS_HALO_UNSC, ROLES_CIC + GLOB.ROLES_POLICE + GLOB.ROLES_AUXIL_SUPPORT + GLOB.ROLES_MISC + GLOB.ROLES_ENGINEERING + GLOB.ROLES_REQUISITION + GLOB.ROLES_MEDICAL + GLOB.ROLES_UNSC_MARINES + GLOB.ROLES_GROUND)
GLOBAL_LIST_INIT(ROLES_DISTRESS_HALO_ODST, ROLES_CIC + GLOB.ROLES_POLICE + GLOB.ROLES_AUXIL_SUPPORT + GLOB.ROLES_MISC + GLOB.ROLES_ENGINEERING + GLOB.ROLES_REQUISITION + GLOB.ROLES_MEDICAL + GLOB.ROLES_ODST + GLOB.ROLES_GROUND)
...
#define FACTION_LIST_HUMANOID list(FACTION_MARINE, FACTION_PMC, FACTION_WY, FACTION_WY_DEATHSQUAD, FACTION_CLF, FACTION_CONTRACTOR, FACTION_MARSHAL, FACTION_UPP, FACTION_FREELANCER, FACTION_SURVIVOR, FACTION_NEUTRAL, FACTION_COLONIST, FACTION_MERCENARY, FACTION_DUTCH, FACTION_HEFA, FACTION_GLADIATOR, FACTION_PIRATE, FACTION_PIZZA, FACTION_SOUTO, FACTION_YAUTJA, FACTION_ZOMBIE, FACTION_TWE, FACTION_ARMY, FACTION_NAVY, FACTION_CANC, FACTION_UA_REBEL, FACTION_TWE_REBEL, FACTION_UNSC, FACTION_INSURGENT, FACTION_UEG_POLICE, FACTION_ONI, FACTION_UNSCN) // SS220 EDIT: include HALO humanoid factions
