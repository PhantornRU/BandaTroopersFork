...
GLOBAL_LIST_INIT(ROLES_MARINES, GLOB.ROLES_USCM_MARINES + list("UNSC Squad Leader", "UNSC Fireteam Leader", "UNSC Weapons Specialist", "UNSC Hospital Corpsman", "UNSC Rifleman", "UNSC Radio Telephone Operator", "ODST Squad Sergeant", "ODST Fireteam Leader", "ODST Weapons Specialist", "ODST Hospital Corpsman", "ODST Rifleman", "ODST Radio Telephone Operator")) // SS220 EDIT: append HALO marine roles without early include dependency on bandamarines/halo_jobs.dm
GLOBAL_LIST_INIT(ROLES_SQUAD_ALL, list(SQUAD_MARINE_1, SQUAD_MARINE_2, SQUAD_MARINE_3, SQUAD_MARINE_4, SQUAD_MARINE_5, SQUAD_MARINE_CRYO, SQUAD_MARINE_INTEL, SQUAD_UPP, SQUAD_LRRP, SQUAD_PMCPLT, SQUAD_PMCPLT_SMALL, SQUAD_RMC, "The Ferrymen")) // SS220 EDIT: add HALO ODST squad without early include dependency on bandamarines/halo_jobs.dm
...
GLOBAL_LIST_INIT(ROLES_USCM, ROLES_CIC + GLOB.ROLES_POLICE + GLOB.ROLES_AUXIL_SUPPORT + GLOB.ROLES_MISC + GLOB.ROLES_ENGINEERING + GLOB.ROLES_REQUISITION + GLOB.ROLES_MEDICAL + GLOB.ROLES_USCM_MARINES - ROLES_WO) // SS220 EDIT: keep vanilla distress roster stable and append modular marine roles separately
