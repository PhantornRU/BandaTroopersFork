...
#define SHIP_MAP_NAMES list("USS Almayer", "USS Golden Arrow",  "USS Golden Arrow (Classic)", "SSV Chapaev", "SSV Laituri", "USS Rover", "USCSS Firefly", "USCSS Obsidian Falk", "USCSS Onyx Karain", "HMS Brynhild", "USS Blue Ridge", "UNSC Dark Was The Night", "UNSC Dark Was The Night (ODSTBay)", "UNSC Stalwart Frigate", "Mackay Station (Shipmap)") // SS220 EDIT: suppress current_map fallbacks on HALO shipmaps
