...
/datum/equipment_preset/corpse/load_name(mob/living/carbon/human/new_human, randomise)
	...
	new_human.change_real_name(new_human, ss220_localize_generated_personal_name(random_name)) // SS220 EDIT: localize generated corpse names before applying them to runtime mobs
