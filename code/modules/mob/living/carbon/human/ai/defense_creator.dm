...
/datum/human_defense_creator_menu/ui_static_data(mob/user)
	...
	data["valid_factions"] = list(FACTION_MARINE, FACTION_UA_REBEL, FACTION_UPP, FACTION_CANC, FACTION_WY, FACTION_FREELANCER, FACTION_TWE, FACTION_TWE_REBEL, FACTION_MERCENARY, FACTION_COVENANT, FACTION_UNSC, FACTION_INSURGENT, FACTION_ONI, FACTION_UNSCN, FACTION_UEG_POLICE) // SS220 EDIT: expose HALO factions to the shared defense creator UI.
