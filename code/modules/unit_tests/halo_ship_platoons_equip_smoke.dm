...
/datum/unit_test/halo_ship_platoons_unsc_equip_smoke/Run()
	...
	configure_test_human(human, "HALO UNSC Corpsman Smoke", JOB_SQUAD_MEDIC_UNSC)
...
/datum/unit_test/halo_ship_platoons_odst_equip_smoke/Run()
	var/mob/living/carbon/human/human = allocate(/mob/living/carbon/human, run_loc_floor_top_right)
	configure_test_human(human, "HALO ODST Rifleman Smoke", JOB_SQUAD_MARINE_ODST)
...
/datum/unit_test/halo_ship_platoons_so_override_smoke/Run()
	...
	var/mob/living/carbon/human/human = allocate(/mob/living/carbon/human, run_loc_floor_top_right)
	configure_test_human(human, "HALO UNSC Platoon Commander Smoke", JOB_SO_UNSC)
...
/datum/unit_test/halo_ship_platoons_specialist_smoke/Run()
	var/mob/living/carbon/human/human = allocate(/mob/living/carbon/human, run_loc_floor_top_right)
	configure_test_human(human, "HALO UNSC Specialist Smoke", JOB_SQUAD_SPECIALIST_UNSC)
