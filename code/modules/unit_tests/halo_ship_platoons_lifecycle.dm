...
/datum/unit_test/halo_ship_platoons_latejoin_role_pod_routing/Run()
	...
	var/mob/living/carbon/human/latejoin_human = create_test_human("HALO Latejoin Pod Routing", JOB_SQUAD_MEDIC_UNSC, /datum/squad/marine/halo/unsc/alpha, run_loc_floor_top_left)
