...
/datum/unit_test/game_rule_panel_rto_disable/Run()
	...
	controller.armed_action_id = RTO_SUPPORT_ARM_VISIBILITY_ZONE
	...
	TEST_ASSERT(controller.can_arm_action(RTO_SUPPORT_ARM_COORDINATES), "Coordinates action should remain available when RTO support is disabled.")
	TEST_ASSERT(controller.can_arm_action(RTO_SUPPORT_ARM_MARKER), "Manual marker action should remain available when RTO support is disabled.")
